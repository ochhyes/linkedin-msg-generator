...
```
Sprint:        #8 — trwała baza profili + auto-backup + dark mode (v1.14.0-1.14.3 COMMITTED) + #49 bulk Resume fix + addCount (v1.14.4 COMMITTED `ce4c0f4`) | Sprint #7 UX redesign #46 wisi (tokeny v1.13.0)
Phase:         PM (v1.14.0-1.14.4 zacommitowane, czeka manual smoke 1.14.3+1.14.4 + push + dystrybucja; nast. sprint: #22 / #24-#28 / #10)
Active task:   żaden (#49 ZAKOMMITOWANY `ce4c0f4` — czeka manual smoke 1.14.4)
Last commit:   3542666 — dark/normal mode + baza + hasło dostępu + loading anim (v1.14.3) [+ 0484c65 v1.14.0-1.14.2]
Updated:       2026-05-12 (#49 v1.14.4 zacommitowany ce4c0f4 — bulk Resume fix + addCount; czeka manual smoke + push + dystrybucja)
```
