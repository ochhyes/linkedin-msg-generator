...
```
Sprint:        #8 — baza profili + auto-backup + dark mode (v1.14.0-1.14.3) + #49 bulk Resume fix + addCount (v1.14.4) + #50 connect-z-profilu (v1.14.5) + #51 X dla hint + master-select (v1.14.6) | Sprint #7 UX #46 wisi
Phase:         PM (v1.14.0-1.14.6 zacommitowane, czeka manual smoke 1.14.6 + push + dystrybucja; nast. sprint: #22 / #24-#28 / #10)
Active task:   żaden (#51 ZAKOMMITOWANY v1.14.6 — czeka manual smoke)
Last commit:   (v1.14.6) — feat: X dla bulk-target hint + master-select checkboxy (#51) [poprzednie: 127ec04 v1.14.5, ce4c0f4 v1.14.4, 3542666 v1.14.3, 0484c65 v1.14.0-1.14.2]
Updated:       2026-05-12 (#51 v1.14.6 — X dla bulk-target hint + master-select checkboxy w liście Bulk; czeka manual smoke + push + dystrybucja)
```
