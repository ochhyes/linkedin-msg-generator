...
```
Sprint:        #8 — baza profili + auto-backup + dark mode (v1.14.0-1.14.3) + #49 bulk Resume fix + addCount (v1.14.4) + #50 connect-z-profilu (v1.14.5) | Sprint #7 UX #46 wisi
Phase:         PM (v1.14.0-1.14.5 zacommitowane, czeka manual smoke 1.14.5 + push + dystrybucja; nast. sprint: #22 / #24-#28 / #10)
Active task:   żaden (#50 ZAKOMMITOWANY — czeka manual smoke 1.14.5)
Last commit:   (v1.14.5) — feat: connect z profilu zamiast ze strony wyszukiwania (#50) [poprzednie: ce4c0f4 v1.14.4, 3542666 v1.14.3, 0484c65 v1.14.0-1.14.2]
Updated:       2026-05-12 (#50 v1.14.5 zacommitowany — connect-z-profilu eliminuje li_not_found; czeka manual smoke + push + dystrybucja)
```
